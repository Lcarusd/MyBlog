...
$(document).ready(function () {
    ...
    if($('#created').val() != undefined && $('#created').val() != null && $('#created').val() != ''){
        $("#created").val(moment.unix($('#created').val()).format("YYYY-MM-DD HH:mm"));
    }
    else{
...
function  autoSave() {
    ...
    if (title != '' && content != '') {
        ...
        var params = $("#articleForm").serializeForm();
        ...
        $(array).each(
            function() {
                if (serializeObj[this.name]) {
                    ...
                    if(this.name === "created"){
                        var _val = moment($('#created').val(), "YYYY-MM-DD HH:mm").unix();
                        serializeObj[this.name] = _val;
                    }else{
                        serializeObj[this.name] = this.value;
                    }
                }
